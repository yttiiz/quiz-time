...
import { Button, Dialog, Input } from "@/components/client.mod";
import {
  FormPasswordConfim,
  IconCrossEye,
  IconEye,
...
export const FormUserPassword = () => {
  ...
  const [errorCreatePasswordMessage, setErrorCreatePasswordMessage] =
    useState("");
  const [isConfirmPasswordEyeOpen, setIsConfirmPasswordEyeOpen] =
    useState(false);
  ...
  return (
    <>
      <form action={formAction} className="grid gap-4 p-10">
        <Input
          label="Mot de passe"
          ...
          onClickPasswordButton={() =>
            setIsCreatePasswordEyeOpen(!isCreatePasswordEyeOpen)
          }
          onInput={(event) => {
        ...
        <Input
          ...
          onClickPasswordButton={() =>
            setIsConfirmPasswordEyeOpen(!isConfirmPasswordEyeOpen)
          }
          onInput={(event) => {
            dispatch({
