...
import { SubmitEvent, useMemo, useReducer, useRef, useState } from "react";
  ...
  return (
    <>
      ...
      <Dialog
        ...
        main={{
          paragraph:
            "Quelque chose s'est mal passé durant votre inscription. Veuillez réessayer ultérieurement.",
        }}
